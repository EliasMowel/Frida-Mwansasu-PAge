...
document.querySelector('#app').innerHTML = `
  ...
  <main id="top">
    <section class="hero section-wrap"><div class="hero-copy"><p class="eyebrow">Legal practitioner <span class="dot"></span> Dar es Salaam</p><h1>Clarity in<br><em>every case.</em></h1><p class="hero-intro">Thoughtful counsel, careful preparation, and a steady advocate when the details matter most.</p><a class="text-link" href="#work">Explore areas of practice <span>↓</span></a></div><div class="hero-art" aria-label="Portrait placeholder for Frida Mwansasu" role="img"><div class="sun-disc"></div><div class="portrait-frame"><div class="portrait-image"></div></div><p class="art-note">Professional<br>profile<br><span>FM / 2024</span></p></div><div class="hero-stamp">FM<br><span>COUNSEL</span></div></section>
  ...
  <footer class="site-footer"><span>© 2024 Frida Mwansasu</span><span>Built with intention <b>✳</b></span><a href="#top">Back to top ↑</a></footer>
`
